...
dataset_dir = cfg.train_data_dir
...
for i in range(n):
    ...
    f_name = data_valid.filenames[i].split("\\")[-1][:-4]
    cv2.imwrite(save_snapshot_dir+str(f_name)+'_valid.bmp', (decoded_imgs[i]*255).astype('uint8'))
