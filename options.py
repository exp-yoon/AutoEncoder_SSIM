...
class Options():
    def __init__(self):
        ...
        self.parser.add_argument('--name', type=str, default='LB')
        ...
        self.parser.add_argument('--do_aug', action='store_true', help='whether to do data augmentation before training',default=False)
        ...
        self.parser.add_argument('--augment_num', type=int, default=0)
        self.parser.add_argument('--im_resize', type=int, default=256, help='scale images to this size')
        self.parser.add_argument('--patch_size', type=int, default=256, help='then crop to this size')
        self.parser.add_argument("--grayscale", action='store_true', help='color or grayscale input image')
        self.parser.add_argument('--p_rotate', type=float, default=0.0, help='probability to do image rotation')
        self.parser.add_argument('--rotate_angle_vari', type=float, default=0.0, help='rotate image between [-angle, +angle]')
        self.parser.add_argument('--p_rotate_crop', type=float, default=0.0, help='probability to crop inner rotated image')
        ...
        self.parser.add_argument('--z_dim', type=int, default=1024, help='dimension of the latent space vector')
        self.parser.add_argument('--flc', type=int, default=32, help='number of the first hidden layer channels')

        self.parser.add_argument('--epochs', type=int, default=1000, help='maximum training epochs')
